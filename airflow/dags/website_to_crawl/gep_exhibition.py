...
def gep_exhibition_crawler_etl():
    output_path = '/opt/airflow/dags/crawling_output/gep_exhibitions.csv'
    ...
    @task()
    def make_dataset(output_path, urls: list):
        gep_exhibitions = []
    ...
    make_dataset(output_path, urls)


gep_exhibition_crawler_etl()
